...
def main():
    ...
    """
    parser = argparse.ArgumentParser(description="Run Natural Niches evolution for LLMs.")
    parser.add_argument(
        "--model1_path",
        type=str,
    ...
    parser.add_argument("--total_forward_passes", type=int, default=100, help="Total number of child model evaluations.")
